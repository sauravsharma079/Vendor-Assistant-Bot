...
import { VeltrianceMark } from "@/components/VeltrianceMark";
    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#f6f7f9] px-6">
      <div className="w-full max-w-sm">
        <div className="mb-6 flex items-center gap-3">
          ...
          <div>
            <p className="font-display text-[15px] font-semibold leading-none text-[#0f1729]">
        ...
        >
          ...
          <input
            ...
            autoFocus
            className="mt-2 w-full rounded-lg border border-black/15 px-3 py-2 text-sm outline-none focus:border-[#C9A227]"
          />
          {error && <p className="mt-2 text-sm text-red-700">{error}</p>}
          <button
            type="submit"
            disabled={loading || !password}
            className="mt-4 w-full rounded-lg bg-[#C9A227] px-4 py-2 text-sm font-medium text-white hover:bg-[#A9860E] disabled:opacity-50"
          >
